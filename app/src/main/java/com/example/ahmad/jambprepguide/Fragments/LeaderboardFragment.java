...
public class LeaderboardFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] datasource = {"Adeyeye Omobola", "Adeolu Igwe", "Adamu Isaac", "Ngozi Khadija"};
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), R.layout.list_row, R.id.name, datasource);
